...
class BaseConfig(object):
    ...
    train_batch_size = entity["pretrain"]["train_batch_size"]

    learning_rate = entity["pretrain"]["learning_rate"]

    samples_path = entity["pretrain"]["samples_path"]

    samples_path1 = entity["pretrain"]["samples_path1"]
    samples_path2 = entity["pretrain"]["samples_path2"]

    for_predict_path=entity["pretrain"]["for_predict_path"]
